const PRODUCTS = [
  { id:1, title:"مياه 330 مل", category:"bottle", price:3, rating:4.4, stock:120, img:"images.jpeg", desc:"زجاجة مياه 330 مل نقية" },
  { id:2, title:"مياه 600 مل", category:"bottle", price:4, rating:4.7, stock:200, img:"images (1).jpeg", desc:"زجاجة 600 مل مناسبة للترطيب" },
  { id:3, title:"مياه 1.5 لتر", category:"bottle", price:6, rating:4.9, stock:150, img:"images (2).jpeg", desc:"زجاجة 1.5 لتر عائلية" },
  { id:4, title:"كرتونة 6 × 330 مل", category:"pack", price:15, rating:4.5, stock:80, img:"images (3).jpeg", desc:"كرتونة اقتصادية صغيرة" },
  { id:5, title:"كرتونة 12 × 1.5 لتر", category:"pack", price:55, rating:4.6, stock:50, img:"images (4).jpeg", desc:"عرض توفير 12 عبوة 1.5 لتر" },
  { id:6, title:"جالون 19 لتر", category:"gallon", price:25, rating:4.2, stock:40, img:"images (5).jpeg", desc:"جالون 19 لتر مع موزع" },
  { id:7, title:"مياه فوارة 330 مل", category:"sparkling", price:7, rating:4.3, stock:70, img:"images (6).jpeg", desc:"مياه فوارة منعشة" },
  { id:8, title:"مياه فوارة 600 مل", category:"sparkling", price:10, rating:4.1, stock:90, img:"images (7).jpeg", desc:"فوارة 600 مل" },
  { id:9, title:"مياه نكهات طبيعية", category:"bottle", price:12, rating:4.0, stock:60, img:"images (8).jpeg", desc:"نكهات طبيعية بدون سكر" },
  { id:10, title:"موزع مياه مكتبي", category:"gallon", price:350, rating:4.8, stock:15, img:"images (9).jpeg", desc:"موزع مياه للمكاتب" }
];
...
function addToCartById(id){
  ...
  saveCart(); renderSidebarCart(); openCart();
}
  ...
  CART.forEach((it, idx)=>{
    ...
    div.innerHTML = `
      ...
      <div style="display:flex;flex-direction:column;gap:6px">
        ...
        <button onclick="removeItem(${idx})" class="btn alt" style="background:#e53e3e;color:#fff">حذف</button>
      </div>
    `;
...
checkoutBtn?.addEventListener('click', ()=>{ if(CART.length===0){ alert('السلة فارغة'); return } openCheckout(); });
